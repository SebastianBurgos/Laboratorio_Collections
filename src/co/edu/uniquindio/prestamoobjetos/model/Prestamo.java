...
public class Prestamo implements Comparable<Prestamo>{
	...
	public void crearDetallePrestamo(Objeto objeto, int unidadesPrestadas) {
		...
		asignarObjetoClientes(); //////////MOSTRARRRRRRRRRRRRRRR
	}
	...
	/**
	 * Metodo que asigna objetos al cliente
	 */
	public void asignarObjetoClientes(){

		if(obtenerObjetosPrestados()!=null){
			if(cliente.getObjetosPrestados() != null) {
				cliente.getObjetosPrestados().add(obtenerObjetosPrestados());
			}
		}
	}
