...
public class PrestadorController {
	...
	public ObservableList<Objeto> getListaObjetosData() {
		List<Objeto> listaObjetos = new ArrayList<Objeto>(aplicacion.obtenerObjetos().values());
		listaObjetosData.addAll(listaObjetos);
    	...
    	try{
    		...
    		if(datosValidosPrestamoEntregado(codigo, fechaPrestamo, fechaEntrega, codigoCliente, codigoEmpleado, codigoObjeto, unidadesPrestadas) == true){
    			...
    			if(prestamo!=null){
    				...
    				mostrarMensaje("Notificación prestamo", "Prestamo no entregado", "No existe un prestamo con el codigo ingresado", AlertType.ERROR);
    			}
    		}
    	}catch(FechasException e1){
